/* @ts-self-types="./normalize_svg.d.ts" */
 ...
 * @param {string} svg
 * @param {number | null} [coordinates_precision]
 * @param {number | null} [transforms_precision]
 * @returns {string}
 */
function normalize(svg, coordinates_precision, transforms_precision) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(svg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.normalize(ptr0, len0, isLikeNone(coordinates_precision) ? 0xFFFFFF : coordinates_precision, isLikeNone(transforms_precision) ? 0xFFFFFF : transforms_precision);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
const wasmPath = `${__dirname}/normalize_svg_bg.wasm`;
